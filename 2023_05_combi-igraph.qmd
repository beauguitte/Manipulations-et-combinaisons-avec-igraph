...
# trnansformation en objet igraph
...
Pourquoi simplifier le réseau ? Tout simplement parce que plusieurs fonctions d`igraph` donnent des résultats erronés si le graphe contient des boucles et/ou des liens multiples.
